...
# parser.add_argument("--latent_size", type=int, default=2048, help='size of the latent z vector')
parser.add_argument("--latent_size", type=int, default=128, help='size of the latent z vector')
